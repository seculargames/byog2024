...
{#await loading}
	<Spinner />
{:then}
	{#if gameStatePersisted.state == 'init'}
		<NewGame />
	{:else}
		...
		<footer class="mt-auto flex flex-col">
			<div class="flex-1">
				This game was built by Abhillash Parra, Nandhini Korra and Arun for <a
					href="https://byog.in/">BYOG 2024</a
				>
			</div>
			<div class="flex-1">
				This game is available on <a href="https://www.seculargames.org/byog2024/"
					>www.seculargames.org/byog2024/</a
				>
				and its source code is hosted on github -
				<a href="https://github.com/seculargames/byog2024/">github.com/seculargames/byog2024</a>
			</div>
			<div class="flex-1">
				This game uses SVGs and icons downloaded from various Creative Commons sites: including the
				following:
				<ul>
